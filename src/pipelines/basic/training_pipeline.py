"""
Pipeline huấn luyện model — chế độ BASIC.

Input : data/basic/03-features/heart_features.csv
Output: models/basic/best_model.pkl

Lưu ý: dataset mất cân bằng khá nặng (~90.6% không bệnh / 9.4% có bệnh),
dùng class_weight='balanced' để model không thiên vị lớp đa số.
"""
