"""
Pipeline dự đoán (inference) cho model bệnh tim đã huấn luyện.
"""
...
def predict(model, X: pd.DataFrame) -> pd.DataFrame:
    """
    Nhận dataframe đặc trưng đã qua feature engineering,
    trả về dataframe gồm prediction và probability.
    """
